...
class Hashtable {
  ...
  void setSeparateChaining(dynamic key, dynamic value) {
    final index = hash(key);
    table[index] = Node(key, value, table[index]);
  }

  void setLinearProbing(dynamic key, dynamic value) {
    var index = hash(key);
  ...
  void setQuadraticProbing(dynamic key, dynamic value) {
    var index = hash(key);
    var i = 1;
    while (table[index] != null) {
